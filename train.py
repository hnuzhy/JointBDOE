...
def train(hyp,  # path/to/hyp.yaml or hyp dictionary
    ...
    compute_loss = ComputeLoss(model, autobalance=False, num_angles=num_angles, 
        wrapped=opt.wrapped, dynamic=opt.dynamic, mse_conf_thre=opt.mse_conf_thre)  # init loss class
    ...
    for epoch in range(start_epoch, epochs):
        ...
        for i, (imgs, targets, paths, _) in pbar:
            ...
            # if i > 50: break  # stop when running 50 batchs in per epoch, only for faster testing
...
def parse_opt(known=False):
    ...
    parser.add_argument('--wrapped', action='store_true', help='whether using wrapped loss of angle in MSE loss')
    parser.add_argument('--dynamic', action='store_true', help='whether using dynamic loss of angle in MSE loss')
